        ...
        <div class="card">
            ...
            <form action="update.php" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-75"><input type="text" id="company_name" name="company_name" value="<?php echo $record['company_name']; ?>" placeholder="Company Name" required></div>
                </div>

                <div class="row">
                    <div class="col-25"><label for="company_business">Company Business:</label></div>
                    <div class="col-75"><input type="text" id="company_business" name="company_business" value="<?php echo $record['company_business']; ?>" placeholder="Company Business"></div>
                </div>

                <div class="row">
                    <div class="col-25"><label for="address">Company Address:</label></div>
                    <div class="col-75"><input type="text" id="address" name="address" value="<?php echo $record['address']; ?>" placeholder="Company Address"></div>
                </div>

                <div class="row">
                    <div class="col-25"><label for="designation">Your Designation:</label></div>
                    <div class="col-75"><input type="text" id="designation" name="designation" value="<?php echo $record['designation']; ?>" placeholder="Your Designation" required></div>
                </div>

                <div class="row">
                    <div class="col-25"><label for="department">Department Name:</label></div>
                    <div class="col-75"><input type="text" id="department" name="department" value="<?php echo $record['department']; ?>" placeholder="Department Name"></div>
                </div>

                <div class="row">
                    <div class="col-25"><label for="responsibilities">Your Responsibilities:</label></div>
                    <div class="col-75">
                        <textarea id="responsibilities" name="responsibilities" placeholder="Your Responsibilities" cols="30" rows="10"><?php echo $record['responsibilities']; ?></textarea>
                    </div>
                </div>

                <div class="row">
                    <div class="col-25"><label for="joining_date">Your Joining Date:</label></div>
                    <div class="col-75"><input type="date" id="joining_date" name="joining_date" value="<?php echo $record['joining_date']; ?>" required></div>
                </div>

                <div class="row">
                    <div class="col-25"><label for="currently_working">Currently Working There:</label></div>
                    <div class="col-75">
                        <input type="radio" id="currently_working" name="currently_working" <?php if($record['currently_working'] == 1) echo 'checked'; ?> value=1>Yes
                        <input type="radio" id="currently_working" name="currently_working" <?php if($record['currently_working'] == 0) echo 'checked'; ?> value=0>No
                    </div>
                </div>

                <div class="row">
                    <div class="col-25"><label for="end_date">Your Job End Date:</label></div>
                    <div class="col-75"><input type="date" id="end_date" name="end_date" value="<?php echo $record['end_date']; ?>"></div>
                </div>
