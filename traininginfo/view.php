    ...
    <div class="rightColumn">
        <div class="card">
            ...
            <table class="table">
                <tbody>
                <tr>
                    <td style="text-align: right;"><strong>Course Name/Training Title</strong></td>
                    <td><?php echo $record['training_title']; ?></td>
                </tr>
                <tr>
                    <td style="text-align: right;"><strong>Course/Training Details</strong></td>
                    <td><?php echo $record['description']; ?></td>
                </tr>
                <tr>
                    <td style="text-align: right;"><strong>Institute Name</strong></td>
                    <td><?php echo $record['institute']; ?></td>
                </tr>
                <tr>
                    <td style="text-align: right;"><strong>Institute Address</strong></td>
                    <td><?php echo $record['address']; ?></td>
                </tr>
                <tr>
                    <td style="text-align: right;"><strong>Training Completion Year</strong></td>
                    <td><?php echo $record['training_year']; ?></td>
                </tr>
                <tr>
                    <td style="text-align: right;"><strong>Training Start Date</strong></td>
                    <td><?php echo $record['start_date']; ?></td>
                </tr>
                <tr>
                    <td style="text-align: right;"><strong>Training End Date</strong></td>
                    <td><?php echo $record['end_date']; ?></td>
                </tr>
                <tr>
                    <td style="text-align: right;"><strong>Training Duration</strong></td>
                    <td><?php echo $record['duration'] .' '. $record['duration_unit']; ?></td>
                </tr>
                <tr>
