        ...
        <div class="card">
            ...
            <form action="add.php" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-50"><input type="text" id="training_title" name="training_title" placeholder="Training Title" required></div>
                    <div class="col-25 input-group">
                        ...
                        <input type="text" id="training_year" name="training_year" placeholder="Training Completion Year" required style="width: auto;">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25"><label for="description">Description:</label></div>
                    <div class="col-75"><textarea id="description" name="description" cols="30" rows="5"></textarea></div>
                </div>
                <div class="row">
                    <div class="col-25"><label for="institute">Training Institute:</label></div>
                    <div class="col-75"><input type="text" id="institute" name="institute" placeholder="Training Institute" required></div>
                </div>
                <div class="row">
                    <div class="col-25"><label for="address">Institute Address:</label></div>
                    <div class="col-75"><input type="text" id="address" name="address" placeholder="Institute Address"></div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-25 input-group">
                        ...
                        <input type="text" id="duration" name="duration" style="width: auto;" required>
