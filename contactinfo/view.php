    ...
    <div class="rightColumn">
        <div class="card">
            ...
            <table class="table">
                <tbody>
                <tr>
                    <td style="text-align: right;"><strong>Contact Person Name</strong></td>
                    <td>
                ...
                <tr>
                    <td style="text-align: right;"><strong>Profession</strong></td>
                ...
                <tr>
                    <td style="text-align: right;"><strong>Primary Mobile</strong></td>
                    <td><?php echo $record['primary_mobile']; ?></td>
                </tr>
                <tr>
                    <td style="text-align: right;"><strong>Secondary Mobile</strong></td>
                    <td><?php echo $record['secondary_mobile']; ?></td>
                </tr>
                <tr>
                    <td style="text-align: right;"><strong>Primary Email</strong></td>
                    <td><?php echo $record['primary_email']; ?></td>
                </tr>
                <tr>
                    <td style="text-align: right;"><strong>Secondary Email</strong></td>
                    <td><?php echo $record['secondary_email']; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: right;"><strong>Present District</strong></td>
                    <td><?php echo $record['present_district']; ?></td>
                </tr>
                <tr>
                    <td style="text-align: right;"><strong>Permanent Address</strong></td>
                    <td><?php echo $record['permanent_address']; ?></td>
                </tr>
                <tr>
                    <td style="text-align: right;"><strong>Permanent District</strong></td>
                    <td><?php echo $record['permanent_district']; ?></td>
                </tr>
                <tr>
